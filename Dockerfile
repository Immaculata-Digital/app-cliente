...
# Variáveis principais (do .env local)
ARG VITE_API_ADMIN_V2_URL
ARG VITE_API_USUARIOS_V2_URL
ARG VITE_API_CLIENTES_URL
ARG VITE_SCHEMA_DEFAULT

# Variáveis do GitHub (usadas no deploy)
ARG VITE_API_ADMIN_URL_HOMOLOG
ARG VITE_API_ADMIN_URL_MAIN
ARG VITE_API_USUARIOS_URL_HOMOLOG
ARG VITE_API_USUARIOS_URL_MAIN
...
ENV VITE_API_ADMIN_URL_HOMOLOG=$VITE_API_ADMIN_URL_HOMOLOG
ENV VITE_API_ADMIN_URL_MAIN=$VITE_API_ADMIN_URL_MAIN
ENV VITE_API_USUARIOS_URL_HOMOLOG=$VITE_API_USUARIOS_URL_HOMOLOG
ENV VITE_API_USUARIOS_URL_MAIN=$VITE_API_USUARIOS_URL_MAIN
